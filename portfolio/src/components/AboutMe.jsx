...
function AboutMe() {
    const lines = [
        <div><span className="red">import</span> 정다희, &#123; 프론트엔드 &#125; from '신입';  </div>,
        "// <!-- 💌 Contact & Channel 📞 -->",
        ...
        <div className="padding20">😀 안녕하세요, 빠르게 변화하는 기술에 맞춰 사용자 친화적인 웹 경 험을 만들기 위해 끊임없이 노력하는 <b>프론트엔드 개발자 정다희</b>라고 합니다.</div>,
        <div className='padding16'> <span className="blue">&lt;/<span className="green">h1</span>&gt;</span></div>,
        ...
        "",
        <div className="padding20">퍼블리셔로서의 경력을 시작한 후로, jQuery와 Vanilla JavaScript 에 대한 전문지식을 확립하기 위해 작은 기능부터 Vanilla JS로 구현해 감으로써 개발에 대한 흥미를 자연스럽게 발견하였고, 이것이 저를 프론트엔드 개발자로서 한 걸음 더 나아가게끔 도왔습니다.</div>,
        "",
        ...
        "",
        <div className="padding20">끊임없는 학습, 의지, 그리고 전문성을 바탕으로 발전하는 것을 목표로 삼아, 항상 발전하는 프론트엔드 개발자가 되려는 열망과 전문성을 가지고 있습니다. 이러한 저의 능력과 경험을 활용하여, 제게 주어질 모든 기회에서 맡은 역할을 최상의 수준으로 수행하겠습니다.</div>,
        <div className='padding16'> <span className="blue">&lt;/<span className="green">pre</span>&gt;</span></div>,
